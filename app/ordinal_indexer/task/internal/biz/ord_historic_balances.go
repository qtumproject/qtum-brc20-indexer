...
type IOrdHistoricBalancesDAO interface {
	...
	HandleTransferInscribeEvent(ctx context.Context, eventInfo OrdEventBO, bo OrdHistoricBalancesBO) error
	HandleSentAsFeeTransferEvent(ctx context.Context, eventInfo OrdEventBO, bo OrdHistoricBalancesBO) error
	HandleMintInscribeEvent(
		ctx context.Context,
		eventInfo OrdEventBO,
		collectionInfo CollectionBO,
		historicBalancesRecord OrdHistoricBalancesBO) error

	HandleDeployInscribeEvent(
		ctx context.Context,
		eventInfo OrdEventBO,
		collectionInfo CollectionBO) error

	HandleTransferTransferEvent(ctx context.Context, eventInfo OrdEventBO, bo OrdHistoricBalancesBO) error
}
...
func (s *OrdHistoricBalancesService) HandleTransferInscribeEvent(
	ctx context.Context, eventInfo OrdEventBO, bo OrdHistoricBalancesBO) error {
	return s.ordHistoricBalancesDAO.HandleTransferInscribeEvent(ctx, eventInfo, bo)
}

func (s *OrdHistoricBalancesService) HandleMintInscribeEvent(
	ctx context.Context,
	eventInfo OrdEventBO,
	collectionInfo CollectionBO, historicBalancesRecord OrdHistoricBalancesBO) error {
	return s.ordHistoricBalancesDAO.HandleMintInscribeEvent(ctx, eventInfo, collectionInfo, historicBalancesRecord)
}

func (s *OrdHistoricBalancesService) HandleDeployInscribeEvent(
	ctx context.Context,
	eventInfo OrdEventBO,
	collectionInfo CollectionBO) error {
	return s.ordHistoricBalancesDAO.HandleDeployInscribeEvent(ctx, eventInfo, collectionInfo)
}

func (s *OrdHistoricBalancesService) HandleSentAsFeeTransferEvent(
	ctx context.Context, eventInfo OrdEventBO, bo OrdHistoricBalancesBO) error {
	return s.ordHistoricBalancesDAO.HandleSentAsFeeTransferEvent(ctx, eventInfo, bo)
}

func (s *OrdHistoricBalancesService) HandleTransferTransferEvent(
	ctx context.Context, eventInfo OrdEventBO, bo OrdHistoricBalancesBO) error {
	return s.ordHistoricBalancesDAO.HandleTransferTransferEvent(ctx, eventInfo, bo)
}
