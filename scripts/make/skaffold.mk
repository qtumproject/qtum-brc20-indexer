...
dry-run-yaml: export IMAGE=web3-container-registry.cn-hongkong.cr.aliyuncs.com/${OWNER_NAME}/foxwallet-server-test/${SERVICE_NAME}:${GIT_REVISION}
...
manifest: export VERSION=${GIT_REVISION}
