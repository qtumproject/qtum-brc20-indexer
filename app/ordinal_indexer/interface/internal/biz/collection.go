...
type ICollectionDAO interface {
	...
	GetCollectionList(
		...
		status string,
		pagination v1.Pagination) ([]CollectionBO, v1.Pagination, error)
...
func (cc *CollectionService) GetCollectionList(
	ctx context.Context, chainId string, tickSearchQuery string, status string, pagination v1.Pagination) ([]CollectionBO, v1.Pagination, error) {
	return cc.collectionDAO.GetCollectionList(ctx, chainId, tickSearchQuery, status, pagination)
}
